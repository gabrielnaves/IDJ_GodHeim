...
Level1State::Level1State() : State(), tileSet(55,55,"img/tiles2.png"),
                             tileMap("map/firstLevel/firstLayer.txt", &tileSet)
{
    ...
    objectArray.emplace_back(new Loki(70,100, MovementMap("map/firstLevel/firstLayer.txt", tileSet)));
    objectArray.emplace_back(new Thor(20,100, MovementMap("map/firstLevel/firstLayer.txt", tileSet)));
